import Img14 from '../assets/image 25.png'
import Logo from '../assets/imagelogo.svg'
function Footer(){
 return(
     <div className='text-white'>
        <div className="bg-[#da5e42] flex items-center justify-center py-2 px-10" >
          <div className="grid grid-cols-5 grid-rows-2 gap-x-20 gap-y-2">
           <img src={Img14} alt="" />
           <img src={Img14} alt="" />
           <img src={Img14} alt="" />
           <img src={Img14} alt="" />
        ...
        <div className='flex items-center justify-center bg-[#d84727] px-20 py-10'>
          <div className='grid grid-cols-4 gap-8'> 
            <div className='flex flex-col '>
             ...
             <div className='mt-6'>
                ...
                <p className='mt-2'>
                Store & Office
                Jl. Setrasari Kulon III, No. 10-12, Sukarasa, Sukasari, Bandung, Jawa Barat, Indonesia 40152
                </p>
            ...
            <div className='flex flex-col'>
            <div className='text-2xl'><span class="inline-block border-b-2 border-white pb-2">Get in touch</span>
            </div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M14.4 19.2V13.8667L18.6667 16.5335L14.4 19.2Z" fill="white"/>
</svg>
            ...
            <div className='flex flex-col'>
            <div className='text-2xl'><span class="inline-block border-b-2 border-white pb-2">Useful Link</span>
            </div>
            ...
            <div className='flex flex-col'>
                <div className='text-2xl'><span class="inline-block border-b-2 border-white pb-2">Campaign</span>
                </div>
                <div className='mt-6'>
                Mengenal Arti Cukup
                </div>
